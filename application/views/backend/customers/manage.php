				...
				<div class="container-fluid container-fixed-lg">
					...
					<div class="panel">
						...
						<ul class="nav nav-tabs nav-tabs-linetriangle" data-init-reponsive-tabs="dropdownfx">
							<li class="active">
								<a data-toggle="tab" href="#branches"><span>Registered Customers</span></a>
							</li>
									...
									<div class="row">
										<div class="col-lg-12 col-md-12">
											...
											<div class="clearfix"></div>
												<table class="table " id="customersDataTable">
													<thead>
														<tr>
                              <td>NAME</td>
                              <td>EMAIL</td>
...
$(document).ready(function() {
	var url = "<?php echo site_url('backend/customers/data') ?>";
